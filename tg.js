...
(function (root) {
  ...
  var LIM = {
    ...
    place: 200, way: 60, pay: 60, num: 20, base: 300, pdn: 60, bytes: 4096,
  };
  ...
  function orderJson(src, tCap, comment, count) {
    ...
    return JSON.stringify({
      ...
      /* согласие на обработку ПД: время галочки и редакция политики.
         Не жертвуется при ужатии — это доказательство, а не украшение. */
      pdn: src.consent && src.consent.at
        ? cut(src.consent.at + '|' + src.consent.doc, LIM.pdn) : '',
